...
let boardList = [{no:1, subject:"테스트 제목1", content:"테스트 내용1", writer:"testid1", writedate:"2021-08-09 13:00:00"},
...
router.post('/', authMiddleware, function(req, res, next) {
	...
	boardItem.writer = req.tokenInfo.memberId;//JWT토큰 payload의 memberId 사용
